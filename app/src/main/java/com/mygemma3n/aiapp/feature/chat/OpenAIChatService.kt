...
class OpenAIChatService @Inject constructor(
    ...
    private val tokenUsageRepository: com.mygemma3n.aiapp.data.repository.TokenUsageRepository,
    private val costPredictionUtils: com.mygemma3n.aiapp.util.CostPredictionUtils,
    private val spendingLimitService: com.mygemma3n.aiapp.service.SpendingLimitService
) {
