...
class CBTSessionManager @Inject constructor(
    ...
    suspend fun initializeKnowledgeBase() = withContext(Dispatchers.IO) {
        try {
            ...
            for (technique in cbtTechniques.getAllTechniques()) {
                ...
                // Generate embedding
                val embedding = geminiApiService.embedText(content) // Correctly uses default EMBEDDING_MODEL
            ...
            for ((id, title, content) in cbtConcepts) {
                val embedding = geminiApiService.embedText(content)
    ...
    suspend fun findRelevantContent(
        ...
        try {
            ...
            val queryEmbedding = geminiApiService.embedText(userInput)
    ...
    suspend fun getPersonalizedRecommendations(
        ...
        try {
            ...
            val queryEmbedding = geminiApiService.embedText(
            ...
            // Generate personalized insights using Gemma 3n
    ...
    /**
     * Generate session insights using Gemma 3n
     */
